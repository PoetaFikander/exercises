<div class="modal devices-info modal-type-1" tabindex="-1" id="modal-bok-devicesInfo" aria-labelledby="workCardModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">

        <div class="modal-content">

            <div class="modal-header" id="modal-header-text">
                <h3 class="modal-title" id="workCardModalLabel">Urządzenie</h3>
                                ...
                                <div class="tab-pane fade show active" id="di-tab-1">
                                    <div class="row">
                                        ...
                                        <fieldset class="border rounded-2 border-1 mt-2">
                                            ...
                                            <legend class="float-none w-auto px-3 fs-6">Kontakty</legend>

                                            <div class="table-responsive mt-3 pt-1">
                                                <table class="table table-striped table-sm table-hover" id="contactTable">
                                                    <thead>
                                                    <tr>
